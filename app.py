...
RESPUESTAS = {
    ...
    "informacion": "Gracias por tu interés en Spinzone Indoorcycling. Somos mucho más que una clase de spinning, ofrecemos una experiencia única que combina intensidad, música envolvente y motivación sin límites. ¿Qué es el Indoor Cycling? El indoor cycling es un entrenamiento cardiovascular de alta energía que se realiza en bicicletas estáticas con resistencia ajustable. Nuestras clases están guiadas por instructores expertos y acompañadas de música motivadora, lo que te ayuda a mejorar tu resistencia, quemar calorías y fortalecer piernas y glúteos mientras disfrutas del ritmo y la energía del grupo. ¿Qué son las Clases Funcionales? Además del indoor cycling, ofrecemos clases funcionales, entrenamientos diseñados para trabajar todo el cuerpo con ejercicios que mejoran la fuerza, resistencia y coordinación. Utilizamos una combinación de peso corporal, bandas, mancuernas y otros elementos para garantizar un entrenamiento completo y efectivo. ¿Por qué elegir Spinzone? Clases dinámicas para todos los niveles. Entrenamiento guiado por instructores certificados. Ambiente motivador con música y energía inigualables. Equipos de última tecnología para un rendimiento óptimo. ¿Dónde estamos ubicados? 2175 Davenport Blvd Davenport Fl 33837. ¿Cómo reservar una clase? Puedes agendar tu clase fácilmente registrandote a través de nuestro sitio web  https://app.glofox.com/portal/#/branch/6499ecc2ba29ef91ae07e461/classes-day-view o contactarnos por WhatsApp +18633171646. Si tienes alguna otra pregunta, estaré encantado de ayudarte. ¡Esperamos verte pronto pedaleando y entrenando con nosotros!"
}
